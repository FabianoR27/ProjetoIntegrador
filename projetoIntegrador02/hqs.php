    ...
    <div class="container-fluid p-0 text-white">
        <!-- HISTÓRIA DAS HQS-->
        <main class="py-lg-5 py-md-5 pt-4 clearfix my-4">
        ...
        <!--Artigo HQs que inspiraram séries-->
        <article class="my-5 clearfix container p-3 p-md-0">
            <div class="text-center">
                <h2 class="h1 pt-4 text-uppercase fw-bold">HQs Que Inspiraram Séries</h2>
            </div>
            <div class="d-flex flex-row flex-md-column justify-content-center gap-3 mt-4 flex-wrap">
                <div class="d-flex flex-column flex-md-row gap-3">
                    <div class="sandman clearfix p-2 p-lg-3 shadow w-100 rounded-3">
                        ...
                        <div class="p-1">
                            <h3 class="fw-semibold">Sandman</h3>
                            <small class="h6 fw-semibold">Neil Gaiman</small>
                            <p class="mt-2">Sandman é uma série de histórias em quadrinhos criada por Neil Gaiman para a Vertigo, selo da DC Comics. A série segue Morpheus, o Senhor dos Sonhos, enquanto ele explora temas profundos como sonhos, morte, destino e desejo. Sandman é aclamada por sua narrativa complexa e foi uma das primeiras HQs a ser reconhecida pela crítica literária, tornando-se um clássico cult e influenciando diversos trabalhos na cultura pop.</p>
                            <a href="https://sandman.fandom.com/pt-br/wiki/Quadrinhos_do_Universo_Sandman" target="_blank" class="btn btn-sm btn-warning fw-semibold link-underline-opacity-0">SAIBA MAIS <i class="bi bi-box-arrow-up-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="the_boys clearfix p-2 p-lg-3 shadow w-100 rounded-3">
                        ...
                        <div class="p-1">
                            <h3 class="fw-semibold">The Boys</h3>
                            <small class="h6 fw-semibold">Garth Ennis e Darick Robertson</small>
                            <p class="mt-2">The Boys é uma série de quadrinhos criada por Garth Ennis e Darick Robertson. A trama subverte o conceito tradicional de super-heróis, retratando um grupo, conhecido como "The Boys", que monitora e combate super-heróis corruptos. A HQ é conhecida por seu humor ácido, violência e crítica à idolatria de figuras públicas, oferecendo uma visão sombria e satírica do universo dos super-heróis.</p>
                            <a href="https://www.galaxiadosquadrinhos.com.br/2020/10/the-boys.html" target="_blank" class="btn btn-sm btn-warning fw-semibold link-underline-opacity-0">SAIBA MAIS <i class="bi bi-box-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column flex-md-row gap-3">
                    <div class="umbrella_academy clearfix p-2 p-lg-3 shadow w-100 rounded-3">
                        ...
                        <div class="p-1">
                            <h3 class="fw-semibold">The Umbrella Academy</h3>
                            <small class="h6 fw-semibold">Gerard Way</small>
                            <p class="mt-2">The Umbrella Academy é uma série de quadrinhos criada por Gerard Way e ilustrada por Gabriel Bá. A história segue uma família disfuncional de irmãos adotivos com superpoderes, reunidos após a morte de seu pai adotivo para investigar mistérios e impedir um apocalipse iminente. A HQ mistura humor, drama e ação, oferecendo uma abordagem única e sombria do universo dos super-heróis.</p>
                            <a href="https://www.ultimatodobacon.com/the-umbrella-academy-hqs" target="_blank" class="btn btn-sm btn-warning fw-semibold link-underline-opacity-0">SAIBA MAIS <i class="bi bi-box-arrow-up-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="walking_dead clearfix p-2 p-lg-3 shadow w-100 rounded-3">
                        ...
                        <div class="p-1">
                            <h3 class="fw-semibold">The Walking Dead </h3>
                            <small class="h6 fw-semibold">Robert Kirkman</small>
                            <p class="mt-2">The Walking Dead é uma série de quadrinhos criada por Robert Kirkman, com arte de Tony Moore e posteriormente Charlie Adlard. A trama acompanha um grupo de sobreviventes em um mundo pós-apocalíptico tomado por zumbis, explorando tanto o horror dos mortos quanto os desafios da humanidade em condições extremas. Focada em temas de sobrevivência, moralidade e relações humanas, a HQ se tornou um marco no gênero e inspirou uma popular adaptação televisiva.</p>
                            <a href="https://walkingdeadbr.com/hqs/" target="_blank" class="btn btn-sm btn-warning fw-semibold link-underline-opacity-0">SAIBA MAIS <i class="bi bi-box-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--Seção HQs que inspiraram filmes-->
        <section class="my-5 pb-5 clearfix px-0">
            <div class="text-center pt-4">
                <h3 class="h1 pt-4 text-uppercase fw-bold">HQs Que Inspiraram filmes</h3>
            </div>
            <div class="container p-3 p-md-0 d-flex flex-column flex-lg-row gap-3">
                <div class="d-flex flex-md-row flex-column justify-content-evenly gap-3 w-100">
                    <div class="deadpool mt-4 p-2 shadow w-100 rounded-3">
                        <div class="text-center py-4">
                            <h3 class="fw-semibold">Deadpool</h3>
                        </div>
                        <div class="text-center">
                            <figure class="px-1">
                        ...
                        <p class="p-2">Deadpool é uma série de quadrinhos da Marvel que acompanha o anti-herói irreverente e mercenário Wade Wilson. Conhecido por seu humor sarcástico, habilidade de quebra da quarta parede e seu fator de cura, Deadpool se tornou um personagem único no universo Marvel. Criado por Fabian Nicieza e Rob Liefeld, Deadpool mistura ação com comédia, frequentemente zombando dos clichês dos próprios quadrinhos.</p>
                    </div>
                    
                    <div class="venom mt-4 p-2 shadow w-100 rounded-3">
                        <div class="text-center py-4">
                            <h3 class="fw-semibold">Venom</h3>
                        </div>
                        <div class="text-center">
                            <figure class="px-1">
                        ...
                        <p class="p-2">Venom é uma série de quadrinhos da Marvel que segue o anti-herói simbiótico que foi, originalmente, um dos maiores vilões do Homem-Aranha. O personagem Venom, um simbionte alienígena que se liga ao jornalista Eddie Brock, possui habilidades incríveis, como força sobre-humana e regeneração. Criado por David Michelinie e Todd McFarlane, Venom é conhecido por seu visual sombrio e moralidade ambígua, tornando-se um dos personagens mais populares e complexos da Marvel.</p>
                    </div>
                </div>

                <div class="d-flex flex-md-row flex-column justify-content-center gap-3 w-100">
                    <div class="v_vingança mt-4 p-2 shadow w-100 rounded-3">
                        <div class="text-center py-4">
                            <h3 class="fw-semibold">V de Vingança</h3>
                        </div>
                        <div class="text-center">
                            <figure class="px-1">
                        ...
                        <p class="p-2">V de Vingança é uma HQ escrita por Alan Moore e ilustrada por David Lloyd, que retrata uma Inglaterra distópica sob regime totalitário. A trama segue V, um vigilante mascarado que luta contra a opressão e busca inspirar a população à revolta. Com temas de liberdade, justiça e resistência, a obra é considerada uma crítica poderosa aos abusos de poder e à perda de direitos civis.</p>
                    </div>
                    
                    <div class="hellboy mt-4 p-2 shadow w-100 rounded-3">
                        <div class="text-center py-4">
                            <h3 class="fw-semibold">Hellboy</h3>
                        </div>
                        <div class="text-center">
                            <figure class="px-1">
                        ...
                        <p class="p-2"> Hellboy é uma HQ criada por Mike Mignola, centrada em um demônio invocado na Terra durante a Segunda Guerra Mundial. Trabalhando como investigador do paranormal, Hellboy luta contra ameaças sobrenaturais, lidando com seu destino sombrio e buscando a redenção. Com traços sombrios e inspirados no horror, a série é conhecida por sua atmosfera única e mitologia rica.</p>
                    </div>
                </div>
            </div>
        </section>

        <!--Aside Autores de HQs-->
        <aside class="autores_hq my-5 pb-5 clearfix px-0">
            <div class="text-center pt-4">
                <h3 class="h1 pt-4 text-uppercase fw-bold">Grandes Autores De HQs</h3>
            </div>

            <div class="container p-3 p-md-0 d-flex flex-column flex-lg-row gap-3 text-dark">
                <div class="d-flex flex-md-row flex-column justify-content-evenly gap-3 w-100">
        ...
        <section class="py-4">
            <div class="container p-2 text-center rounded-3 py-4">
                <h3 class="h2 fw-bold text-danger">CONHEÇA TAMBÉM: 5 SÉRIES QUE TROUXERAM AS HQS PARA A TV</h3>
                <p class="lead">Heróis, Vilões e Muito Mais: veja aqui 5 Séries de TV que Vieram das Histórias em Quadrinhos</p>
                <a class="btn btn-secondary btn-lg" href="series.php">SAIBA MAIS</a>
            </div>
        </section>
    </div>
