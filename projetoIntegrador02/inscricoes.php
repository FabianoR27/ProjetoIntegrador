...
<div class="container col-xl-10 col-xxl-8 px-4 py-2">
    <main class="row align-items-center g-lg-5 py-5">
        <!-- Texto explicativo -->
        <aside class="col-lg-6 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 text-danger mb-3">Formulário de Inscrição</h1>
        ...
        <div class="col-md-10 mx-auto col-lg-6">
            <form class="p-2 p-md-5 border rounded-3 bg-dark">
                ...
                <button class="btn btn-lg btn-danger mt-4 w-100" type="submit">Inscrever-se</button>
                <hr class="my-4">
                <div class="mb-3 text-center">
                    <small class="text-light">Ao clicar em Inscrever-se, você concorda com os <a href="normas.php" class="text-warning">termos de uso.</a></small>
                </div>
            </form>
        </div>
    </main>
